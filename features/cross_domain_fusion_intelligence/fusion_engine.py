class FusionEngine:
    ...
    def predict_human_driven_attack(self, user_id: str):
        ...
        """
        if (
            user_id not in self.psychological_models
            or user_id not in self.economic_models
            or user_id not in self.linguistic_models
        ):
        ...
        ling_risk = "urgent" in self.linguistic_models[user_id].get(
            "recent_communication_style", ""
        )
