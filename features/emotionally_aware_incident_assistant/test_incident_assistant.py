...
def run_assistant_test():
    ...
    scenarios = [
        ...
        {
            "level": "high",
            "description": "Multiple failed login attempts from a suspicious IP.",
        },
        {"level": "medium", "description": "An unusual port scan was detected."},
        {
            "level": "low",
            "description": "A new device has connected to the guest network.",
        },
    ]
    ...
    for scenario in scenarios:
        ...
        response = assistant.generate_response(
            scenario["level"], scenario["description"]
        )
