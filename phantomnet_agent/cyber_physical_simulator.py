...
class ICSDevice:
    ...
    def __init__(self, device_id: str, device_type: str, protocol: str):
        ...
        print(
            f"ICS Device {self.device_id} ({self.device_type}) using {self.protocol} initialized."
        )
...
class CyberPhysicalSimulator:
    ...
    def run_simulation_step(self):
        ...
        for device in self.devices:
            ...
            # Simulate a recovery
            if (
                device.status != "operational" and random.random() < 0.05
...
if __name__ == "__main__":
    ...
    ics_devices = [
        ...
        ICSDevice(
            device_id="Sensor-05", device_type="Temperature Sensor", protocol="BACnet"
        ),
