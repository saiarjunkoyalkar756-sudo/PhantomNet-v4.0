...
venv_lib_path = os.path.join(project_root, '.venv_phantomnet', 'Lib', 'site-packages') # Windows venv structure
...
a = Analysis(
    ...
    excludes=[
        ...
        'pydoc', 'asyncio.unix_events', # Unix-specific for Windows build
        # Exclude platform-specific adapters not for this OS if we were building universal
        # For Windows, exclude linux_adapter, termux_adapter from direct inclusion if possible
        'phantomnet_agent.platform_compatibility.linux_adapter',
