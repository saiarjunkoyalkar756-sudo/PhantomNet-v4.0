...
MITRE_ATTACK_DATA = {
    ...
    "T1021": {
        ...
        "description": "Adversaries may use valid accounts to log into a service that may be exposed to the network (e.g., SSH, RDP).",
    },
    "T1078": {
        "name": "Valid Accounts",
        "description": "Adversaries may steal credentials or use legitimate credentials to bypass authentication mechanisms.",
    },
    ...
    def load_bert_model(self):
        ...
        try:
            ...
            self.model = AutoModelForSequenceClassification.from_pretrained(
                model_name, num_labels=len(MITRE_ATTACK_DATA)
            )  # Dummy num_labels
