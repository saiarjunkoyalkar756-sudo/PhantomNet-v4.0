...
if __name__ == "__main__":
    ...
    # Example queries
    print(
        f"Copilot Response: {copilot.query_copilot('Show all brute-force patterns from China last week')}\n"
    )
    print(
        f"Copilot Response: {copilot.query_copilot('What are the recent privilege escalation attempts?')}\n"
    )
    print(
        f"Copilot Response: {copilot.query_copilot('Tell me about network scans.')}\n"
    )
